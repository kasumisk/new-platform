...
export function ImageCropper() {
  ...
  const handleWidthChange = (val: string) => {
    ...
    let newRect = { ...cropRect, w: clamped };
  ...
  const handleHeightChange = (val: string) => {
    ...
    let newRect = { ...cropRect, h: clamped };
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          上传图片进行裁切，支持鼠标拖拽选区、自定义尺寸输入、旋转翻转，所有处理均在浏览器本地完成
        </p>
      </div>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-lg font-medium">
                  {isDragActive ? '释放以上传图片' : '拖拽图片到此处，或点击上传'}
                </p>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                提示：在图片上拖拽鼠标可绘制新的裁切区域，拖动边框和手柄可调整大小，拖动中间可移动选区
              </p>
            </CardContent>
          </Card>
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">裁切尺寸 (px)</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    <Label className="text-xs mb-1 block">X 偏移</Label>
                    <Input
                      type="number"
                      min={0}
                      max={imgNatW - 1}
                  ...
                  <div className="flex-1">
                    <Label className="text-xs mb-1 block">Y 偏移</Label>
                    <Input
                      type="number"
                      min={0}
                      max={imgNatH - 1}
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">宽高比</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">旋转 & 翻转</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center gap-3">
                  <Label className="text-xs w-10">旋转</Label>
                  <Slider
                    value={[rotation]}
                    min={0}
                    max={360}
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">输出设置</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div>
                  <Label className="text-xs mb-1.5 block">格式</Label>
                  <div className="flex gap-2">
                ...
                {OUTPUT_FORMATS[outputFormat].value !== 'image/png' && (
                  <div className="flex items-center gap-3">
                    <Label className="text-xs w-10">质量</Label>
                    <Slider
                      value={[quality]}
                      min={10}
                      max={100}
            ...
            {resultUrl && (
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm">裁切结果</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
